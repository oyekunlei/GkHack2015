...
<head>
	...
	<![endif]-->
        <%@page import="com.geekedin.geek.Geek,com.geekedin.challenge.Challenge, com.geekedin.skill.Skill,java.util.Vector" %>
</head>
		...
		<div class="row">
			<div class="col-md-12">
				<section id="portfolio" class="page-section section appear clearfix">
					...
					<br />
					<p>
						Find out a challenge you can take, and click on JOIN to become part of a team. 
						<br />
						<br />
					</p>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="row">
                                                            <%
                                                                Vector<Challenge> challenges = (Vector<Challenge>) session.getAttribute("catChallenges");
                                                                Vector<Geek> geeks = (Vector<Geek>) session.getAttribute("geeks");
                                                                Vector<Integer> teams = (Vector<Integer>) session.getAttribute("teams");
                                                                ...
                                                                if(challenges != null)
                                                                {
                                                                    for(Challenge challenge: challenges)
                                                                    {
                                                                        %>
                                                                        <div class="col-lg-6"> 
                                                                            <div class="challenge_view">
                                                                        <input type="hidden" name="challengeId" value="<%=challenge.getId()%>"/>
                                                                            <h3><strong>Challenge Name:</strong> <%=challenge.getName()%></h3>
                                                                            <br><strong>Overview:</strong> <%=challenge.getOverview()%>
                                                                            <%
                                                                                for(Geek g: geeks)
                                                                                {
                                                                                    if(g.getId() == challenge.getGeekId())
                                                                                    {
                                                                                
                                                                            %>
                                                                            <br><strong>Geek Name:</strong> <%=g.getName()%>
                                                                            <br><strong>Skills needed:</strong>
                                                                            <%
                                                                                    }
                                                                                }
                                                                                for(int s: challenge.getSkills())
                                                                                {
                                                                            ...
                                                                            %>
                                                                            <br> <strong><%=teams.get(count)%> team(s) took the challenge</strong>
                                                                        </div>  
                                                                        </div>
                                                                        <%
                                                                                count++;
