				...
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="challenges.html">View Challenges</a></li>
							<li><a href="add_challenge.html">Add A Challenge</a></li>
						</ul>
					</li>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Your challenge name">
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea name="contest_entry" rows="5" cols="76" id="form-entry"></textarea>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							...
							<button type="submit" class="btn btn-two">Publish</button><p><br/></p>
						</form>
